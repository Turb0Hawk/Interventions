import {validateurLongueur } from './validateurLongueur';
...
describe('Zones Validator', () =>{
  ...
  it('une phrase avec des mots est minimum', () => {
    let validator = validateurLongueur.minimum(3);
  ...
  it('une phrase avec 3 espaces, des mots et ensuite 3 espaces est minimum', () =>{
    let validator = validateurLongueur.minimum(3);
  ...
  it('une phrase avec 3 espaces et 3 caractères est minimum', () =>{
    let validator = validateurLongueur.minimum(3);
  ...
  it('une phrase avec 5 espaces, 5 caractères et 5 espaces est minimum', () =>{
    let validator = validateurLongueur.minimum(3);
